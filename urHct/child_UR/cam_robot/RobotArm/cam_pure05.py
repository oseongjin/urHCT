...
rblogger.setLevel(logging.DEBUG)
...
if os.path.isfile('/home/pi/work/RobotArm/robotcfg.dat'):
    with open('/home/pi/work/RobotArm/robotcfg.dat', 'r') as jfp:
...
pretrained_model = cv2.dnn.readNet('/home/pi/work/RobotArm/models/face-detection-adas-0001.xml','/home/pi/work/RobotArm/models/face-detection-adas-0001.bin')
pretrained_model.setPreferableTarget(cv2.dnn.DNN_TARGET_MYRIAD)


landmark_pretrained_model = cv2.dnn.readNet('/home/pi/work/RobotArm/models/facial-landmarks-35-adas-0002.xml','/home/pi/work/RobotArm/models/facial-landmarks-35-adas-0002.bin')
...
def handle_client(client_socket, addr):
    rblogger.debug("Connetced by {}".format(addr))
    global cnt
    global tmpRcv
    while True:
        try:
            ...
            global before_positions 
            before_positions = ""
            rblogger.debug(str(e))
            rblogger.debug("main loop exception ")

            client_socket.close()
            break
            
    rblogger.debug("exiting loop")
...
try:
    ...
    while True:
        try:
            rlst = dsp_sock.connect((DSP_IP, int(DSP_PORT)))
            break
        except:
            pass
    ...
    while True:
        try:
            rlst = cam_sock.connect((camhost,camport))
            break
        except:
            pass
    ...
    rblogger.debug("main Thread start")
    HOST = ''
