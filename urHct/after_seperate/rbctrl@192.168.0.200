...
m_per_pixel = 00.00002  # Variable which scales the robot movement from pixels to meters. 0.000012
f_per_pixel = 00.000035  #00,000025   00.000055
...
print("point Value",args.point)
print("point Value",detect_point)
